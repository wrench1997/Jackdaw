...
test('Headless Chrome - Private Tabs', async function (group) {
  ...
  group.test('Open 2 new private tabs', async function (t) {
    const tabA = await browser.newTab({ privateTab: true })
