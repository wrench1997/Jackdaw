...
const defaultOptions = {
  ...
  browser: {
    loadPageTimeout: 15000,
    loadSelectorInterval: 500,
    loadSelectorTimeout: 15000,
...
class Browser extends EventEmitter {
  ...
  async init() {
    ...
    try {
      ...
      this.chromeInstance && await this.chromeInstance.kill()
      throw err
    }
  }
  ...
  async close(exit = true) {
    ...
    try {
      ...
      this._tabs = []
      this._closedTabs = []
      exit && this.chromeInstance && await this.chromeInstance.kill('SIGHUP')
